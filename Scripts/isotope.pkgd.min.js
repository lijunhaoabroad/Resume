...
(function(t) {
    ...
    function n(t, n, r) {
        ...
        var p = r("transition"), u = r("transform"), h = p && u, f=!!r("perspective"), c = {
            WebkitTransition: "webkitTransitionEnd",
            MozTransition: "transitionend",
            OTransition: "otransitionend",
            transition: "transitionend"
        }
        [p], l = ["transform", "transition", "transitionDuration", "transitionProperty"], d = function() {
    ...
    function s(i, s, f, l, d, y) {
        function m(t, i) {
            if ("string" == typeof t && (t = a.querySelector(t)), !t ||!c(t))
                return p && p.error("Bad " + this.constructor.namespace + " element: " + t), void 0;
        ...
        return m.namespace = "outlayer", m.Item = y, m.prototype.options = {
            ...
            for (var e = this.options.itemSelector, i = [], n = 0, r = t.length; r > n; n++) {
                ...
                if (c(s))
                    if (e) {
                        d(s, e) && i.push(s);
                        for (var a = s.querySelectorAll(e), p = 0, u = a.length; u > p; p++)
                            i.push(a[p])
                    } else 
                        i.push(s)
            }
    ...
    var a = t.document, p = t.console, u = t.jQuery, h = function() {}, f = Object.prototype.toString, c = "object" == typeof HTMLElement ? function(t) {
    ...
    function e(t, e) {
        ...
        return o.prototype._resetLayout = function() {
            ...
            for (var r = this._getColGroup(n), s = Math.min.apply(Math, r), a = i(r, s), p = {
                ...
                y: s
            }, u = s + t.size.outerHeight, h = this.cols + 1 - r.length, f = 0; h > f; f++)
                this.colYs[a + f] = u;
            return p
            ...
            for (var p = (this.options.isOriginTop ? o.top : o.bottom) + i.outerHeight, u = s; a >= u; u++)
                this.colYs[u] = Math.max(p, this.colYs[u])
